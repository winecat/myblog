...
class Widget_Abstract_Contents extends Widget_Abstract
{
    ...
    public function content($more = false)
    {
        ...
        //$this->excerpt . "<pclass=\"more\"><a href=\"{$this->permalink}\" title=\"{$this->title}\">{$more}</a></p>" : $this->content;
        $this->excerpt . "<p><a href=\"{$this->permalink}\" title=\"{$this->title}\">{$more}</a></p>" : $this->content;
    }
